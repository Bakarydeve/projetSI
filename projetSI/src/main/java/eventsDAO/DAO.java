...
public abstract class DAO<D> {
    ...
    */
    public abstract D find(short id) throws DAOException;
     ...
     */
    public abstract void create(D data) throws DAOException, NoSuchAlgorithmException;
     ...
     * @throws NoSuchAlgorithmException 
     */
    public abstract void update(D data) throws DAOException, NoSuchAlgorithmException;
    ...
    /**
     * Retourne � partir du support de persistance tout les objets.
     * @return l'instance de l'objet
     * @throws DAOException en cas de probl�me
    */
    public abstract List<D> findAll(Class<D> entityClass) throws DAOException;
